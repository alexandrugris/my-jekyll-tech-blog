...
### Some compiler specific assumptions:
 ...
 - `ebp` is the root of the function stack.[`/Oy` will crash our code](https://msdn.microsoft.com/en-us/library/2kxx5t2c.aspx). This restriction could be removed through some extra push / pops. 
