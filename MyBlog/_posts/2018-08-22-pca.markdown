...
1. When to use the correlation and when to use the covariance matrix: [https://stats.stackexchange.com](https://stats.stackexchange.com/questions/53/pca-on-correlation-or-covariance)

2. Why use covariance (or correlation at all) - because we are interested in finding the axes which describe the highest variation of data:
