...
The input variables for the model above are `scored / received by home / away team`, `number of matches considered` and `home / away average scored` which can be obtained by looking up values on the internet, on each league page, for instance. Great sites are [here](https://www.fctables.com/) and [here](http://www.football-lineups.com/)
